...
('0609674321', '22/07/1985', 'Luc�a', 'Mart�nez', 'F', '01/06/2019', LOWER(TRANSLATE('Luc�a','ÁÉÍÓÚáéíóúÑñ','AEIOUaeiouNn')) + '.' + LOWER(TRANSLATE('Mart�nez','ÁÉÍÓÚáéíóúÑñ','AEIOUaeiouNn')) + '@correo.com'),
...
('1709846732', '30/09/1988', 'Sof�a', 'Mendoza', 'F', '12/11/2019', LOWER(TRANSLATE('Sof�a','ÁÉÍÓÚáéíóúÑñ','AEIOUaeiouNn')) + '.' + LOWER(TRANSLATE('Mendoza','ÁÉÍÓÚáéíóúÑñ','AEIOUaeiouNn')) + '@correo.com'),
('1702389671', '15/04/1979', 'Marcos', 'G�mez', 'M', '10/09/2018', LOWER(TRANSLATE('Marcos','ÁÉÍÓÚáéíóúÑñ','AEIOUaeiouNn')) + '.' + LOWER(TRANSLATE('G�mez','ÁÉÍÓÚáéíóúÑñ','AEIOUaeiouNn')) + '@correo.com'),
...
('1709328475', '19/10/1991', 'Camila', 'R�os', 'F', '07/05/2019', LOWER(TRANSLATE('Camila','ÁÉÍÓÚáéíóúÑñ','AEIOUaeiouNn')) + '.' + LOWER(TRANSLATE('R�os','ÁÉÍÓÚáéíóúÑñ','AEIOUaeiouNn')) + '@correo.com'),
...
('1704758392', '07/10/1985', 'Iv�n', 'Zamora', 'M', '23/09/2018', LOWER(TRANSLATE('Iv�n','ÁÉÍÓÚáéíóúÑñ','AEIOUaeiouNn')) + '.' + LOWER(TRANSLATE('Zamora','ÁÉÍÓÚáéíóúÑñ','AEIOUaeiouNn')) + '@correo.com'),
...
('0602847561', '04/07/1982', 'Tom�s', 'Carrillo', 'M', '12/09/2018', LOWER(TRANSLATE('Tom�s','ÁÉÍÓÚáéíóúÑñ','AEIOUaeiouNn')) + '.' + LOWER(TRANSLATE('Carrillo','ÁÉÍÓÚáéíóúÑñ','AEIOUaeiouNn')) + '@correo.com'),
('1701947352', '15/03/2000', 'Ismael', 'Cede�o', 'M', '10/01/2021', LOWER(TRANSLATE('Ismael','ÁÉÍÓÚáéíóúÑñ','AEIOUaeiouNn')) + '.' + LOWER(TRANSLATE('Cede�o','ÁÉÍÓÚáéíóúÑñ','AEIOUaeiouNn')) + '@correo.com'),
('0602847932', '28/09/1991', 'Roc�o', 'Espinoza', 'F', '12/09/2018', LOWER(TRANSLATE('Roc�o','ÁÉÍÓÚáéíóúÑñ','AEIOUaeiouNn')) + '.' + LOWER(TRANSLATE('Espinoza','ÁÉÍÓÚáéíóúÑñ','AEIOUaeiouNn')) + '@correo.com'),
...
('0609837452', '23/07/1995', 'Mar�a', 'Qui��nez', 'F', '09/03/2019', LOWER(TRANSLATE('Mar�a','ÁÉÍÓÚáéíóúÑñ','AEIOUaeiouNn')) + '.' + LOWER(TRANSLATE('Qui��nez','ÁÉÍÓÚáéíóúÑñ','AEIOUaeiouNn')) + '@correo.com'),
('1705748392', '02/01/2001', 'Kevin', 'Ch�vez', 'M', '17/11/2022', LOWER(TRANSLATE('Kevin','ÁÉÍÓÚáéíóúÑñ','AEIOUaeiouNn')) + '.' + LOWER(TRANSLATE('Ch�vez','ÁÉÍÓÚáéíóúÑñ','AEIOUaeiouNn')) + '@correo.com'),
('0602948573', '17/10/1989', 'Lorena', 'Mu�oz', 'F', '28/09/2018', LOWER(TRANSLATE('Lorena','ÁÉÍÓÚáéíóúÑñ','AEIOUaeiouNn')) + '.' + LOWER(TRANSLATE('Mu�oz','ÁÉÍÓÚáéíóúÑñ','AEIOUaeiouNn')) + '@correo.com'),
...
('0603748569', '09/08/1984', 'Mauricio', 'Villacorta', 'M', '15/12/2018', LOWER(TRANSLATE('Mauricio','ÁÉÍÓÚáéíóúÑñ','AEIOUaeiouNn')) + '.' + LOWER(TRANSLATE('Villacorta','ÁÉÍÓÚáéíóúÑñ','AEIOUaeiouNn')) + '@correo.com'),
('1703829471', '06/05/1990', 'Tatiana', 'Guam�n', 'F', '13/10/2018', LOWER(TRANSLATE('Tatiana','ÁÉÍÓÚáéíóúÑñ','AEIOUaeiouNn')) + '.' + LOWER(TRANSLATE('Guam�n','ÁÉÍÓÚáéíóúÑñ','AEIOUaeiouNn')) + '@correo.com'),
('0601928743', '29/12/1993', '�lvaro', 'Corozo', 'M', '03/03/2020', LOWER(TRANSLATE('�lvaro','ÁÉÍÓÚáéíóúÑñ','AEIOUaeiouNn')) + '.' + LOWER(TRANSLATE('Corozo','ÁÉÍÓÚáéíóúÑñ','AEIOUaeiouNn')) + '@correo.com');
GO
